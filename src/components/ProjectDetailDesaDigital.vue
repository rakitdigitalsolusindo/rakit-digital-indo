...
const images = [
  '/detail-images-app/desadigital (1).png',
  '/detail-images-app/desadigital (2).png',
  '/detail-images-app/desadigital (3).png',
  '/detail-images-app/desadigital (4).png',
  '/detail-images-app/desadigital (5).png',
];
