...
const images = [
  '/detail-images-app/masjiddigital (1).png',
  '/detail-images-app/masjiddigital (2).png',
  '/detail-images-app/masjiddigital (3).png',
  '/detail-images-app/masjiddigital (4).png',
  '/detail-images-app/masjiddigital (5).png',
  '/detail-images-app/masjiddigital (6).png',
  '/detail-images-app/masjiddigital (7).png',
  '/detail-images-app/masjiddigital (8).png',
  '/detail-images-app/masjiddigital (9).png',
  '/detail-images-app/masjiddigital (10).png',
  '/detail-images-app/masjiddigital (11).png',
];
