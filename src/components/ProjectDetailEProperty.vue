...
const images = [
  '/detail-images-app/E-property (1).png',
  '/detail-images-app/E-property (2).png',
  '/detail-images-app/E-property (3).png',
  '/detail-images-app/E-property (1).png',
  '/detail-images-app/E-property (4).png',
  '/detail-images-app/E-property (5).png',
  '/detail-images-app/E-property (6).png',
];
