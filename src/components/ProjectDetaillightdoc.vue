...
const images = [
  '/detail-images-app/lightdoc (1).png',
  '/detail-images-app/lightdoc (2).png',
  '/detail-images-app/lightdoc (3).png',
  // '/detail-images-app/lightdoc(3).jpeg',
  // '/detail-images-app/lightdoc(4).jpeg',
];
